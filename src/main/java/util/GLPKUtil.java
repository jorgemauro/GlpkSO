...
public class GLPKUtil {
    ...
    public static void write_lp_solucao(glp_prob lp, String fileName) {
        try {
    ...
    public static void set_fx_restricoes(glp_prob lp, SWIGTYPE_p_int ind, SWIGTYPE_p_double val, double[] bounds, double[][] restricoes, int firstConstraint, int lastConstraint, int numberVariables) {
    ...
    public static void set_up_restricoes(glp_prob lp, SWIGTYPE_p_int ind, SWIGTYPE_p_double val, double[] bounds, double[][] restricoes, int firstConstraint, int lastConstraint, int numberVariables) {
        for (int i = firstConstraint; i <= lastConstraint ; i++) {
            GLPK.glp_set_row_name(lp, i, "c" + i);
    ...
    public static void set_lo_restricoes(glp_prob lp, SWIGTYPE_p_int ind, SWIGTYPE_p_double val, double[] bounds, double[][] restricoes, int firstConstraint, int lastConstraint, int numberVariables) {
        for (int i = firstConstraint; i <= lastConstraint ; i++) {
            GLPK.glp_set_row_name(lp, i, "c" + i);
